...
upa_pattern_conventional(1, 1, 90, 0, 1)

upa_pattern_conventional(8, 8, 90, 0, 0)
upa_pattern_conventional(8, 8, 90, 0, 1)

upa_pattern_conventional(8, 8, 105, 30, 0)
upa_pattern_conventional(8, 8, 105, 30, 1)

upa_pattern_conventional(8, 8, 70, -45, 0)
upa_pattern_conventional(8, 8, 70, -45, 1)

upa_pattern_conventional(4, 32, 100, 60, 0)
upa_pattern_conventional(4, 32, 100, 60, 1)


function [] = upa_pattern_conventional(Nz, Ny, theta_1_deg, phi_1_deg, directive)
...
if theta_1 ~= pi/2 || phi_1 ~= 0
    ...
    text2 = "UE (" + num2str(theta_1_deg) + char(176) + ", " + num2str(phi_1_deg) + char(176) + ")";
